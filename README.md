...
Copy `.env.example` to `.env` and set API keys before using Claude or OpenAI-backed features.
...
- Generate Claude prompts that require citations in `[Điều X, trang Y, Hợp đồng Z]` form.
